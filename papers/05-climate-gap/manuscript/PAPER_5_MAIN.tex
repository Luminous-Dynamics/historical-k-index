...
\toprule
\textbf{Harmony} & \textbf{Dimension} & \textbf{Climate Function} \\
\midrule
H$_1$ & Institutional Coherence & International agreements, enforcement, policy \\
H$_2$ & Systemic Interdependence & Carbon markets, green finance, incentive alignment \\
H$_3$ & Cooperative Reciprocity & Burden-sharing trust, compliance belief, cooperation \\
H$_4$ & Adaptive Diversity \& Inclusion & Just transition capacity, inclusive governance \\
H$_5$ & Epistemic Capacity & Climate science, solutions sharing, education \\
H$_6$ & Biophysical Wellbeing & Adaptation capacity, equity, human development \\
H$_7$ & Techno-Social Complexity & Energy grids, transport, physical adaptation \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
    \item \textbf{H$_1$ Institutional Coherence}: Varieties of Democracy, World Governance Indicators
    \item \textbf{H$_2$ Systemic Interdependence}: World Bank, IMF fiscal data, KOF indices
    \item \textbf{H$_3$ Cooperative Reciprocity}: World Values Survey, Eurobarometer, Gallup
    \item \textbf{H$_4$ Adaptive Diversity \& Inclusion}: Diversity indices, minority rights data
    \item \textbf{H$_5$ Epistemic Capacity}: UNESCO education statistics, R\&D data
    \item \textbf{H$_6$ Biophysical Wellbeing}: Human Development Index, health indicators
    \item \textbf{H$_7$ Techno-Social Complexity}: ITU ICT indicators, energy infrastructure data
\end{itemize}
