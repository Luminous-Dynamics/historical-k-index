...
\begin{abstract}
\noindent
This paper examines regional divergence in global coordination capacity using the K-Index framework established in previous work. Analyzing 147 countries across ten world regions from 1990--2020, we find substantial and growing coordination inequality that parallels but does not correlate perfectly with economic inequality. Our analysis reveals that trust (H$_3$) explains 61\% of regional divergence, far exceeding the explanatory power of GDP per capita (23\%) or institutional age (18\%). We identify five regions exhibiting pre-collapse coordination signatures: South Asia, Sub-Saharan Africa, parts of Latin America, the Middle East/North Africa, and---surprisingly---several high-income Western democracies experiencing rapid trust erosion. Network analysis reveals concentrated contagion pathways where coordination collapse in key nodes could trigger cascading failures affecting 40\% of global trade. We map investment priorities, finding that \$1 invested in trust infrastructure in fragile regions yields 4.2$\times$ the coordination return of equivalent investment in already-stable regions. These findings have direct implications for international development policy, suggesting that coordination capacity---not merely economic output---should guide resource allocation.

\vspace{1em}
\noindent\textbf{Keywords:} K-Index, regional development, coordination capacity, trust, institutional quality, contagion risk, development policy
\end{abstract}
...
Table~\ref{tab:regional_k} presents K-Index values by region as of 2020.
...
Network analysis reveals that coordination collapse risk is not uniformly distributed but concentrated in specific pathways.
